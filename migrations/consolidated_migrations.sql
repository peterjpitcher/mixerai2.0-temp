...
CREATE TABLE IF NOT EXISTS brands (
  ...
  brand_summary TEXT,
  created_by UUID,
  approved_content_types JSONB DEFAULT '[]'::jsonb,
  company TEXT,
...
CREATE INDEX IF NOT EXISTS idx_workflows_content_type_id ON workflows(content_type_id);
...
CREATE POLICY "Everyone can view content types" ON public.content_types
  FOR SELECT USING (true);
