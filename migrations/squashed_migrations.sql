-- MixerAI 2.0 - Squashed Migrations
...
-- Insert test admin user (optional - uncomment to include)
...
## How to Dispose:
When it''s time to replace your toothbrush (approximately every 3 months), simply remove the bristles and compost the handle. The bamboo will naturally decompose, returning to the earth without harmful residue.'
  END,
  CASE 
