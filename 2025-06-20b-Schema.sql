...
CREATE OR REPLACE FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid" DEFAULT NULL::"uuid", "p_ingredient_id" "uuid" DEFAULT NULL::"uuid", "p_product_ids" "uuid"[] DEFAULT ARRAY[]::"uuid"[], "p_country_codes" "text"[] DEFAULT ARRAY[]::"text"[], "p_description" "text" DEFAULT NULL::"text", "p_created_by" "uuid" DEFAULT "auth"."uid"(), "p_workflow_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_claim_id UUID;
...
BEGIN
  ...
  IF p_level = 'ingredient' AND p_ingredient_id IS NULL THEN
    RAISE EXCEPTION 'ingredient_id is required for ingredient-level claims';
  END IF;
  ...
  -- Insert the claim (without deprecated columns)
  INSERT INTO claims (
    claim_text,
    claim_type,
    level,
    ...
    CASE WHEN p_level = 'ingredient' THEN p_ingredient_id ELSE NULL END,
    p_description,
    p_created_by,
    p_workflow_id
  ...
  -- If workflow is provided, initialize it
  IF p_workflow_id IS NOT NULL THEN
    PERFORM assign_workflow_to_claim(v_claim_id, p_workflow_id);
  END IF;
...
ALTER FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid", "p_ingredient_id" "uuid", "p_product_ids" "uuid"[], "p_country_codes" "text"[], "p_description" "text", "p_created_by" "uuid", "p_workflow_id" "uuid") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid", "p_ingredient_id" "uuid", "p_product_ids" "uuid"[], "p_country_codes" "text"[], "p_description" "text", "p_created_by" "uuid", "p_workflow_id" "uuid") IS 'Creates a claim with proper associations to products and countries using junction tables. Use this instead of directly inserting into claims table.';
...
CREATE OR REPLACE FUNCTION "public"."get_brand_details_by_id"("p_brand_id" "uuid") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    brand_record RECORD;
...
BEGIN
    ...
    IF NOT FOUND THEN
        RETURN json_build_object('error', 'Brand not found');
    END IF;

    -- Get master claim brand name if exists
    IF brand_record.master_claim_brand_id IS NOT NULL THEN
        SELECT name INTO master_claim_brand_name FROM master_claim_brands WHERE id = brand_record.master_claim_brand_id;
    ELSE
        master_claim_brand_name := NULL;
    END IF;

    -- Get selected vetting agencies
    ...
    SELECT COALESCE(json_agg(
        json_build_object(
            ...
            'full_name', COALESCE(p.full_name, au.raw_user_meta_data->>'full_name', 'Unknown User')
        )
    ), '[]'::json) INTO brand_admins_json
    FROM user_brand_permissions ubp
    LEFT JOIN auth.users au ON ubp.user_id = au.id
    LEFT JOIN profiles p ON ubp.user_id = p.id
    WHERE ubp.brand_id = p_brand_id AND ubp.role = 'admin';

    -- Get content count
    SELECT COUNT(*) INTO content_count FROM content WHERE brand_id = p_brand_id;

    -- Get workflow count
    SELECT COUNT(*) INTO workflow_count FROM workflows WHERE brand_id = p_brand_id;

    -- Return the complete brand details
    RETURN json_build_object(
        'id', brand_record.id,
        'name', brand_record.name,
        'website_url', brand_record.website_url,
        'normalized_website_domain', brand_record.normalized_website_domain,
        'additional_website_urls', brand_record.additional_website_urls,
        'country', brand_record.country,
        'language', brand_record.language,
        'brand_identity', brand_record.brand_identity,
        'tone_of_voice', brand_record.tone_of_voice,
        'guardrails', brand_record.guardrails,
        'brand_color', brand_record.brand_color,
        'logo_url', brand_record.logo_url,
        'master_claim_brand_id', brand_record.master_claim_brand_id,
        'master_claim_brand_name', master_claim_brand_name,
        'created_at', brand_record.created_at,
        'updated_at', brand_record.updated_at,
        'selected_vetting_agencies', selected_agencies_json,
        'brand_admins', brand_admins_json,
...
COMMENT ON FUNCTION "public"."get_claim_countries"("claim_uuid" "uuid") IS 'Returns array of country codes associated with a claim';
...
COMMENT ON FUNCTION "public"."get_claim_products"("claim_uuid" "uuid") IS 'Returns array of product IDs associated with a claim';
...
CREATE OR REPLACE FUNCTION "public"."update_brand_with_agencies"("p_brand_id_to_update" "uuid", "p_name" "text", "p_website_url" "text", "p_additional_website_urls" "text"[], "p_country" "text", "p_language" "text", "p_brand_identity" "text", "p_tone_of_voice" "text", "p_guardrails" "text", "p_brand_color" "text", "p_master_claim_brand_id" "uuid", "p_selected_agency_ids" "uuid"[], "p_new_custom_agency_names" "text"[], "p_user_id" "uuid", "p_logo_url" "text" DEFAULT NULL::"text") RETURNS "json"
    ...
    AS $$
        ...
        BEGIN
            ...
            -- Only query for master claim brand name if ID is not null
            IF updated_brand_record.master_claim_brand_id IS NOT NULL THEN
                SELECT name INTO master_claim_brand_name FROM master_claim_brands WHERE id = updated_brand_record.master_claim_brand_id;
            ELSE
                master_claim_brand_name := NULL;
            ...
            RETURN json_build_object(
                ...
                'guardrails', updated_brand_record.guardrails,
                'brand_color', updated_brand_record.brand_color,
                'logo_url', updated_brand_record.logo_url,
                'master_claim_brand_id', updated_brand_record.master_claim_brand_id,
                'master_claim_brand_name', master_claim_brand_name,
                'created_at', updated_brand_record.created_at,
                'updated_at', updated_brand_record.updated_at,
        ...
        EXCEPTION
            WHEN unique_violation THEN
                RETURN json_build_object('error', 'A brand with this name already exists. Please choose a different name.');
            WHEN foreign_key_violation THEN
                RETURN json_build_object('error', 'Invalid reference. Please check the provided agency IDs and master claim brand ID.');
            WHEN OTHERS THEN
...
CREATE OR REPLACE FUNCTION "public"."update_content_workflow_status"("p_content_id" "uuid", "p_user_id" "uuid", "p_action" "text", "p_comments" "text" DEFAULT NULL::"text", "p_new_assignee_id" "uuid" DEFAULT NULL::"uuid", "p_version_data" "jsonb" DEFAULT NULL::"jsonb") RETURNS TABLE("success" boolean, "error_message" "text", "new_status" "text", "new_step" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
  BEGIN
    ...
    SELECT status, current_workflow_step, workflow_id
    INTO v_current_status, v_current_step, v_workflow_id
    FROM content
    ...
    -- Determine new status and step based on action
    IF p_action = 'approve' THEN
      -- Move to next step or complete
      IF v_workflow_id IS NOT NULL THEN
        SELECT COUNT(*) INTO v_new_step
        FROM workflow_steps
        WHERE workflow_id = v_workflow_id
        AND order_index > v_current_step;
        
        IF v_new_step > 0 THEN
    ...
    INSERT INTO content_versions (
      ...
      p_content_id,
      COALESCE(p_version_data, jsonb_build_object(
        'status_changed_from', v_current_status,
        'status_changed_to', v_new_status,
        'step_changed_from', v_current_step,
        'step_changed_to', v_new_step
      )),
      p_user_id,
      p_action,
      p_comments
    ...
    -- Update content status and step
    UPDATE content
    SET 
      status = v_new_status,
      current_workflow_step = v_new_step,
      updated_at = NOW()
    WHERE id = p_content_id;

    -- Update workflow assignment if new assignee provided
    IF p_new_assignee_id IS NOT NULL AND v_workflow_id IS NOT NULL THEN
      ...
      ON CONFLICT (workflow_id, step_order, user_id) 
      DO UPDATE SET 
        assigned_at = NOW(),
        assigned_by = p_user_id;
    END IF;

    RETURN QUERY SELECT true, NULL::text, v_new_status, v_new_step;
...
ALTER FUNCTION "public"."update_content_workflow_status"("p_content_id" "uuid", "p_user_id" "uuid", "p_action" "text", "p_comments" "text", "p_new_assignee_id" "uuid", "p_version_data" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."claims_with_arrays" AS
 SELECT "c"."id",
    ...
    "public"."get_claim_countries"("c"."id") AS "country_codes",
        CASE
            WHEN ("c"."level" = 'brand'::"public"."claim_level_enum") THEN "mcb"."name"
            WHEN ("c"."level" = 'ingredient'::"public"."claim_level_enum") THEN "i"."name"
            ELSE NULL::"text"
        END AS "entity_name",
        CASE
   ...
   FROM (("public"."claims" "c"
     LEFT JOIN "public"."master_claim_brands" "mcb" ON (("c"."master_brand_id" = "mcb"."id")))
     LEFT JOIN "public"."ingredients" "i" ON (("c"."ingredient_id" = "i"."id")));


ALTER TABLE "public"."claims_with_arrays" OWNER TO "postgres";


COMMENT ON VIEW "public"."claims_with_arrays" IS 'Use this view to get claims with their associated products and countries as arrays. The product_id and country_code columns in the claims table are deprecated.';
...
CREATE POLICY "Users can create feedback" ON "public"."feedback_items" FOR INSERT TO "authenticated" WITH CHECK (("created_by" = "auth"."uid"()));



CREATE POLICY "Users can create reviews for brands they have editor/admin acce" ON "public"."claim_reviews" FOR INSERT TO "authenticated" WITH CHECK ((((((("auth"."jwt"() ->> 'user_metadata'::"text"))::"json" ->> 'role'::"text") = 'admin'::"text") OR (EXISTS ( SELECT 1
   FROM ("public"."master_claim_brands" "mcb"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "mcb"."mixerai_brand_id")))
  WHERE (("mcb"."id" = "claim_reviews"."master_claim_brand_id") AND ("mcb"."mixerai_brand_id" IS NOT NULL) AND ("ubp"."user_id" = "auth"."uid"()) AND ("ubp"."role" = ANY (ARRAY['editor'::"public"."user_brand_role_enum", 'admin'::"public"."user_brand_role_enum"])))))) AND ("reviewed_by" = "auth"."uid"())));



CREATE POLICY "Users can insert analytics for their content brands" ON "public"."analytics" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."content" "c"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "c"."brand_id")))
  WHERE (("c"."id" = "analytics"."content_id") AND ("ubp"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can update analytics for their content brands" ON "public"."analytics" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."content" "c"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "c"."brand_id")))
  WHERE (("c"."id" = "analytics"."content_id") AND ("ubp"."user_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."content" "c"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "c"."brand_id")))
  WHERE (("c"."id" = "analytics"."content_id") AND ("ubp"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can update their own feedback" ON "public"."feedback_items" FOR UPDATE TO "authenticated" USING (("created_by" = "auth"."uid"())) WITH CHECK (("created_by" = "auth"."uid"()));
...
CREATE POLICY "Users can view analytics for their content brands" ON "public"."analytics" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."content" "c"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "c"."brand_id")))
  WHERE (("c"."id" = "analytics"."content_id") AND ("ubp"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view feedback assigned to them" ON "public"."feedback_items" FOR SELECT TO "authenticated" USING (("assigned_to" = "auth"."uid"()));
...
CREATE POLICY "Users can view reviews for brands they have access to" ON "public"."claim_reviews" FOR SELECT TO "authenticated" USING (((((("auth"."jwt"() ->> 'user_metadata'::"text"))::"json" ->> 'role'::"text") = 'admin'::"text") OR (EXISTS ( SELECT 1
   FROM ("public"."master_claim_brands" "mcb"
     JOIN "public"."user_brand_permissions" "ubp" ON (("ubp"."brand_id" = "mcb"."mixerai_brand_id")))
  WHERE (("mcb"."id" = "claim_reviews"."master_claim_brand_id") AND ("mcb"."mixerai_brand_id" IS NOT NULL) AND ("ubp"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "Users can view their own feedback" ON "public"."feedback_items" FOR SELECT TO "authenticated" USING (("created_by" = "auth"."uid"()));
...
GRANT ALL ON FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid", "p_ingredient_id" "uuid", "p_product_ids" "uuid"[], "p_country_codes" "text"[], "p_description" "text", "p_created_by" "uuid", "p_workflow_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid", "p_ingredient_id" "uuid", "p_product_ids" "uuid"[], "p_country_codes" "text"[], "p_description" "text", "p_created_by" "uuid", "p_workflow_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_claim_with_associations"("p_claim_text" "text", "p_claim_type" "public"."claim_type_enum", "p_level" "public"."claim_level_enum", "p_master_brand_id" "uuid", "p_ingredient_id" "uuid", "p_product_ids" "uuid"[], "p_country_codes" "text"[], "p_description" "text", "p_created_by" "uuid", "p_workflow_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_content_workflow_status"("p_content_id" "uuid", "p_user_id" "uuid", "p_action" "text", "p_comments" "text", "p_new_assignee_id" "uuid", "p_version_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."update_content_workflow_status"("p_content_id" "uuid", "p_user_id" "uuid", "p_action" "text", "p_comments" "text", "p_new_assignee_id" "uuid", "p_version_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_content_workflow_status"("p_content_id" "uuid", "p_user_id" "uuid", "p_action" "text", "p_comments" "text", "p_new_assignee_id" "uuid", "p_version_data" "jsonb") TO "service_role";
