...
export function UnifiedNavigation() {
  ...
  const navItemsDefinition: (NavItem | NavGroupItem | NavSpacer & { show?: boolean | (() => boolean) })[] = [
    ...
    {
      label: 'Product Claims (Deprecated)',
      icon: <ShieldCheck className="h-5 w-5" />,
      segment: 'claims',
      defaultOpen: false,
      show: () => isPlatformAdmin || isScopedAdmin || (isEditor && hasAssignedBrandWithMasterClaimId()),
      items: [
        { href: '/dashboard/claims', label: 'Claims (Deprecated)', icon: <ShieldCheck className="h-4 w-4" />, segment: 'claims' },
        { href: '/dashboard/claims/pending-approval', label: 'Pending (Deprecated)', icon: <ClipboardList className="h-4 w-4" />, segment: 'pending-approval' },
        { href: '/dashboard/claims/preview', label: 'Matrix (Deprecated)', icon: <LayoutGrid className="h-4 w-4" />, segment: 'claims-matrix' },
        { href: '/dashboard/claims/workflows', label: 'Workflows (Deprecated)', icon: <GitBranch className="h-4 w-4" />, segment: 'workflows' },
        { href: '/dashboard/claims/overrides', label: 'Overrides (Deprecated)', icon: <Globe2 className="h-4 w-4" />, segment: 'overrides' },
        { href: '/dashboard/claims/brand-review', label: 'Review (Deprecated)', icon: <SearchCheck className="h-4 w-4" />, segment: 'brand-review' },
        { href: '/dashboard/claims/products', label: 'Products (Deprecated)', icon: <Package className="h-4 w-4" />, segment: 'products' },
        { href: '/dashboard/claims/ingredients', label: 'Ingredients (Deprecated)', icon: <FlaskConical className="h-4 w-4" />, segment: 'ingredients' },
        { href: '/dashboard/claims/brands', label: 'Brands (Deprecated)', icon: <Building2 className="h-4 w-4" />, segment: 'brands' },
      ]
    },
