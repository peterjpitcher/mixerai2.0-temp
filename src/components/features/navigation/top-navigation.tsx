...
export function TopNavigation() {
  ...
  return (
    <header className="text-white h-16 flex items-center px-6 sticky top-0 z-50 shadow-md bg-primary">
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-4">
          {/* Mobile menu button */}
          <Button variant="ghost" className="lg:hidden p-0 text-white hover:bg-white/20 hover:text-white">
