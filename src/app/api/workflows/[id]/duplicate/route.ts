...
const prepareStepForTableInsertion = (sourceStep: unknown, newWorkflowId: string, stepOrder: number) => {
  const step = sourceStep as Record<string, unknown>;
  return {
    ...
    role: step.role ? String(step.role) : null,
