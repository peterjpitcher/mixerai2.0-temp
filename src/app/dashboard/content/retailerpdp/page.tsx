  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button asChild>
          <Link href="/dashboard/content/new?type=Retailer%20PDP">Create New Retailer PDP</Link>
        </Button>
      </div>
      ...
      <div className="border rounded-lg p-8 text-center">
        ...
        <Button variant="outline" asChild>
          <Link href="/dashboard/content/new?type=Retailer%20PDP">Create Your First Retailer PDP</Link>
        </Button>
      </div>
    </div>
  );
