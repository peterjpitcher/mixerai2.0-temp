...
CREATE TABLE IF NOT EXISTS "public"."claims" (
    ...
    "completed_workflow_steps" integer DEFAULT 0 NOT NULL,
...
COMMENT ON COLUMN "public"."claims"."completed_workflow_steps" IS 'Number of workflow steps that have been completed for this claim';
...
CREATE INDEX "idx_claims_completed_workflow_steps" ON "public"."claims" USING "btree" ("completed_workflow_steps");
