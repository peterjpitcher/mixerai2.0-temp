-- Migration: Enable global claims blocking with proper safeguards (Part 1)
-- Date: 2025-07-02
-- Version: 1.0.0
...
-- Grant permissions on audit table only (market_claim_overrides already has grants)
GRANT SELECT ON global_override_audit TO authenticated;
GRANT INSERT ON global_override_audit TO service_role; -- Only service role can insert audit records
