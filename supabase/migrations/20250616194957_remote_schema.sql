...
ALTER TABLE ONLY "public"."claim_workflow_history"
    ADD CONSTRAINT "claim_workflow_history_workflow_step_id_fkey" FOREIGN KEY ("workflow_step_id") REFERENCES "public"."workflow_steps"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."claims"
    ADD CONSTRAINT "claims_current_workflow_step_fkey" FOREIGN KEY ("current_workflow_step") REFERENCES "public"."workflow_steps"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."claims"
    ADD CONSTRAINT "claims_workflow_id_fkey" FOREIGN KEY ("workflow_id") REFERENCES "public"."workflows"("id") ON DELETE SET NULL;
